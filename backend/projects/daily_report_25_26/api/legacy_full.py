...
COAL_INVENTORY_DEBUG_FILE = resolve_project_runtime_path(PROJECT_KEY, "test.md")
GONGRE_DEBUG_FILE = SysPath(__file__).resolve().parents[3] / "configs" / "111.md"
GONGRE_SHEET_KEYS = {"gongre_branches_detail_sheet"}
BASIC_TEMPLATE_PATH = resolve_project_config_path(PROJECT_KEY, "数据结构_基本指标表.json")
...
def _load_data_file_candidates() -> List[str]:
    ...
    project_config_path = resolve_project_list_path()
